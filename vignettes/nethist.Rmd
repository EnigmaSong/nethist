...
- **Multi-layer**: Song & Olhede (2026+). *Graph Limits for Sparse Multilayer Networks*.
...
plot(result, type = "prob", prob = TRUE,
     col = colorRampPalette(c("#FFFFFF", "#08306B"))(50))
```
...
Song, Y. & Olhede, S. C. (2026+). Graph limits for sparse multilayer networks. *Preprint*.
